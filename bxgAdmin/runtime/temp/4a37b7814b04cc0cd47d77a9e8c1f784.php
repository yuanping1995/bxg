<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\bxg\bxgAdmin/./application/admin\view\areasite\index.html";i:1509699765;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <a href="profile.html">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="http://img1.2345.com/duoteimg/qqTxImg/2012/04/08/13336817038119.jpg" width="80" height="80">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <h3><strong>百信购-保定站</strong></h3>
                            <div class="">
                                <p>订单量：123,123</p>
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="profile.html">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="http://img1.3lian.com/gif/more/11/2012/03/1a92b3afb07e757970bfdcac20f9561b.gif" width="80" height="80">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <h3><strong>百信购-保定站</strong></h3>
