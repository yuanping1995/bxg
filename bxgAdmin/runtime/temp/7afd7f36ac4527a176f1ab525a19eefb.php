<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\newbxg\bxgAdmin/./application/admin\view\order\reserve_order.html";i:1510025883;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="ibox-content"> 
                <div class="clients-list">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a data-toggle="tab" href="#order-2">待消费订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-3">待付款订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-4">消费中订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-5">待评价订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-6">退货订单</a></li>
                                    ...
                                    <table id="allOrder" data-height="580" data-mobile-responsive="true">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>已推送</td>
                                                <td><span class="label label-danger">待消费</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>2017-10-10 14:59:00</td>
                                                <td>已推送</td>
                                                <td><span class="label label-warning">消费中</span></td>
                                                <td><a href="<?php echo url('admin/order/order_detail'); ?>" class="label label-primary">查看</a></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>2017-10-10 14:59:00</td>
                                                <td>已推送</td>
                                                <td><span class="label label-danger">退货</span></td>
                                                <td><a href="<?php echo url('admin/order/order_detail'); ?>" class="label label-primary">查看</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
