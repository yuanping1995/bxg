<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\bxg\bxgAdmin/./application/admin\view\login\index.html";i:1509612584;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <script type="text/javascript">
        ...
        function loginBtn(){
            ...
            if(uname === ''){
                ...
                $.ajax({
                    type:'post',
                    data:{Mobilenumber:uname,pass:pword},
                    url:'../../api/Ajaxadmin/Login',
                    success:function(data){
                        var data = eval(data);
                        if(data.state === '1111'){
                            window.location.href = '<?php echo __APPROOT__; ?>/index.php/admin';
                        }else{
                            $(".error-tip").html(data.msg);
                        }
                    }
                });
            }
