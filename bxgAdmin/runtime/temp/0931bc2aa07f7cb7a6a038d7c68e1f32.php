<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\admin\bxg\bxgAdmin/./application/admin\view\index\index_v.html";i:1509330632;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="<?php echo __APPROOT__; ?>/static/admin/css/plugins/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="<?php echo __APPROOT__; ?>/static/admin/css/plugins/font-awesome.min.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="<?php echo __APPROOT__; ?>/static/admin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="<?php echo __APPROOT__; ?>/static/admin/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/flot/jquery.flot.symbol.js"></script>

    <!-- Peity -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="<?php echo __APPROOT__; ?>/static/admin/js/demo/sparkline-demo.js"></script>
