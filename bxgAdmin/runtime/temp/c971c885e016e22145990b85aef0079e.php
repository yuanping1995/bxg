<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\WWW\admin\bxg\bxgAdmin/./application/admin\view\index\index.html";i:1509498969;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element" style="padding:0 45px;text-align:center;">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                               <!--  <li><a class="J_menuItem" href="form_avatar.html">修改头像</a>
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo url('admin/index/login'); ?>">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo url('admin/index/user_list'); ?>">会员管理</a>
                            </li>
                        </ul>
                    </li>
