<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpStudy\WWW\bxg\bxgAdmin/./application/admin\view\index\user_list.html";i:1509604497;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="gray-bg">
                                    ...
                                    <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): if( count($arr)==0 ) : echo "" ;else: foreach($arr as $key=>$vo): ?>
                                        ...
                                        <tr data-uid="<?php echo $vo['uId']; ?>">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success setRechargeClick" aria-hidden="true" title="充值" data-toggle="modal" data-target="#recharge" ><i class="glyphicon glyphicon-usd"></i></a>
    ...
    <script>
        $(document).ready(function () {
            ...
            // $(".setRoleClick").on('click',function(){
            //     var uid = $(this).parents('tr').attr("data-uid");
            //     $('#setRole').on('show.bs.modal', function (e) {
