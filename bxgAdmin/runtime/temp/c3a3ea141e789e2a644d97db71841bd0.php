<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\bxg\bxgAdmin/./application/admin\view\order\belong_order.html";i:1509695689;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="ibox-content"> 
                <div class="clients-list">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a data-toggle="tab" href="#order-2">充值订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-3">短信订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-4">升级订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-5">兑换订单</a></li>
                        <li class=""><a data-toggle="tab" href="#order-6">公益订单</a></li>
                    </ul>
                                    ...
                                    <table id="allOrder" data-height="580" data-mobile-responsive="true">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>13598745869</td>
                                                <td>充值</td>
                                                <td>2017-10-10 14:59:00</td>
                                                <td><span class="label label-primary">成功</span></td>
