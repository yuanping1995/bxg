<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\newbxg\bxgAdmin/./application/admin\view\order\order_detail.html";i:1510025595;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
            ...
            <div class="col-sm-12">
                <div class="ibox-content p-xl">
                    ...
                    <div class="table-responsive m-t">
                    	<h3 class="alert alert-success">商家:<?php echo $vo[0]['Sellerid']; ?></h3>
                        <table class="table invoice-table">
                            ...
                            <tbody>
                            <?php if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): if( count($vo)==0 ) : echo "" ;else: foreach($vo as $k=>$vo_1): ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?php echo $Delivery[$vo_1['goodsid']]['Distribution']; ?>:<?php echo $Delivery[$vo_1['goodsid']]['Distributionnumber']; ?></td>
                                </tr>
